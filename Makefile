...
modules:
	    @echo '#define DRIVERVERSION "v5.12.1_ohd_$(shell git rev-parse --short HEAD)"' > $(VERSION_HEADER)
modules:
...
clean:
	@echo '#define DRIVERVERSION "v5.12.1_ohd_THIS_IS_DIRTY"' > $(VERSION_HEADER)
